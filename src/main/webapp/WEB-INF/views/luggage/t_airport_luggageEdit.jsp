...
<script type="text/javascript">
		$(function() {		
		$('#t_airport_luggageEditForm').form({
			url : '${path }/t_airport_luggage/edit',
			onSubmit : function() {
				progressLoad();
	...
	$("#out_name").combobox({
	 ...
	 $("#type").val("${t_airport_luggage.type}");
	 $("#attr").val("${t_airport_luggage.attr}");
	 $("#bgstatus").val("${t_airport_luggage.bgstatus}");
</script>
<div class="easyui-layout" data-options="fit:true,border:false" >
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;" >
		<form id="t_airport_luggageEditForm" method="post">
			<table class="grid">
				<tr>
					<td style="text-align: right;">航班日期</td>
					<td><input name="id" hidden="hidden" value="${t_airport_luggage.id}"><input name="plandate" style="width:200px;" type="text"
					    class="easyui-datebox"
						data-options="required:true" value="${t_airport_luggage.plandate}"></td>
					...
					<td><input name="aircorp" style="width:200px;" type="text"
						...
						data-options="required:true" value="${t_airport_luggage.aircorp}"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input name="bgcode" style="width:200px;" type="text"
						...
						data-options="required:true" value="${t_airport_luggage.bgcode}"></td>
				...
				<tr>
					...
					<td><select id="attr" class="easyui-combobox" name="attr"
						style="width:200px;" panelHeight="120px;" data-options="required:true">
					...
					<td><input name="bgweight" style="width:200px;" type="number"
					 class="easyui-numberbox span2" value="${t_airport_luggage.bgweight}" /></td>
				</tr>
				<tr>
					...
					<td><input name="bgphoto" style="width:200px;" type="text"
			            ...
			            value="${t_airport_luggage.bgphoto}"></td>
					<td style="text-align: right;">行李状态</td>
					<td><select id="bgstatus" class="easyui-combobox" name="bgstatus"
					...
					<td><input id="trailercode" name="trailercode" style="width:200px;" type="text"
                         value="${t_airport_luggage.trailercode}"></td>
					<td style="text-align: right;">操作员</td>
					<td><input id="op_name" name="personcode" style="width:200px;" 
					     type="text"value="${t_airport_luggage.personcode}"></td>
				</tr>
					<tr>
					<td style="text-align: right;">滑槽编号</td>
					<td><input id="chuteno" name="chutecode" style="width:200px;" type="text"
						 value="${t_airport_luggage.chutecode}"></td>
					<td style="text-align: right;">下滑槽时间</td>
					<td><input name="chuteTime" style="width:200px;" type="text"
						placeholder="请输入下滑槽时间" class="easyui-datetimebox"
						 value=""></td>
				</tr>
					
					<tr>
					<td style="text-align: right;">装车时间</td>
					<td><input name="trailerTime" style="width:200px;" type="text"
						placeholder="请输入装车时间" class="easyui-datetimebox span2"
						 value="${t_airport_luggage.trailerTime}"></td>
					<td style="text-align: right;">出库时间</td>
					<td><input name="outTime" style="width:200px;" type="text"
						placeholder="请输入下出库时间" class="easyui-datetimebox span2"
						 value="${t_airport_luggage.outTime}"></td>
				</tr>
					
					<tr>
					<td style="text-align: right;">进舱时间</td>
					<td><input name="inCabinTime" style="width:200px;" type="text"
						placeholder="请输入进舱时间" class="easyui-datetimebox span2"
						 value="${t_airport_luggage.inCabinTime}"></td>
					<td style="text-align: right;">进舱操作员</td>
					<td><input id="in_name" name="inCabinEmployeeId" style="width:200px;" type="text"
						 value="${t_airport_luggage.inCabinEmployeeId}"></td>
				</tr>
					...
					<td><input name="cationArea" style="width:200px;" type="text"
						placeholder="请输入进舱分区" class="easyui-validatebox span2"
						 value="${t_airport_luggage.cationArea}"></td>
					<td style="text-align: right;">出舱时间</td>
					<td><input name="outCabinTime" style="width:200px;" type="text"
						placeholder="请输入出舱时间" class="easyui-datetimebox span2"
						 value="${t_airport_luggage.outCabinTime}"></td>
				</tr>
					
					<tr>
					<td style="text-align: right;">出舱操作员</td>
					<td><input id="out_name" name="outCabinEmployeeId" style="width:200px;" type="text"
						 value="${t_airport_luggage.outCabinEmployeeId}"></td>
					...
					<td><input name="bglevel" style="width:200px;" type="text"
						placeholder="请输入行李级别" class="easyui-validatebox span2"
						 value="${t_airport_luggage.bglevel}"></td>
				</tr>
					<tr>
					...
					<td><input name="chkdesk" style="width:200px;" type="text"
						placeholder="请输入值机柜台" class="easyui-validatebox span2"
						 value="${t_airport_luggage.chkdesk}"></td>
					<td style="text-align: right;">值机时间</td>
					<td><input name="inChkTime" style="width:200px;" type="text"
						placeholder="请输入值机时间" class="easyui-datetimebox span2"
						 value="${t_airport_luggage.inChkTime}"></td>
				</tr>
				<tr>
					...
					<td colspan="3"><input name="REMARTK" style="width:550px;height:80px;" type="text"
						placeholder="请输入备注" class="easyui-validatebox span2"
						 value="${t_airport_luggage.remartk}"></td>
				</tr>
			</table>
		</form>
	</div>
