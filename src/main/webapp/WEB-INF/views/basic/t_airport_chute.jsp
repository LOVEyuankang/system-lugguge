            ...
            columns : [ [ {
                ...
                formatter : function(value, row, index) {
                    var str = '';
                        ...
                        <%--</shiro:hasPermission>--%>
                        <%--<shiro:hasPermission name="/t_airport_chute/delete">--%>
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
...
// 		}]);
   ...
   function addFun() {
        parent.$.modalDialog({
            ...
            width : 400,
            height : 290,
            href : '${path }/t_airport_chute/addPage',
            buttons : [ {
                text : '确定',
                handler : function() {
    ...
    function editFun(id) {
        ...
        parent.$.modalDialog({
            ...
            width : 400,
            height : 290,
            href : '${path }/t_airport_chute/editPage?id=' + id,
            buttons : [ {
                text : '确定',
                handler : function() {
    ...
    function deleteFun(id) {
        ...
        parent.$.messager.confirm('询问', '您是否要删除当前滑槽信息？', function(b) {
            if (b) {
                progressLoad();
                $.post('${path }/t_airport_chute/delete', {
                    id : id
                }, function(result) {
                    if (result.success) {
...
<body class="easyui-layout" data-options="fit:true,border:false">
    ...
    <div id="toolbar" style="display: none;">
        <%--<shiro:hasPermission name="/t_airport_chute/add">--%>
