    ...
    <script type="text/javascript">
        ...
        $(function() {
            dataGrid = $('#dataGrid').datagrid({
                url : '${path }' + '/t_airport_warning_threshold/dataGrid',
                striped : true,
                rownumbers : true,
                pagination : true,
                singleSelect : true,
...
// 		}]);
        ...
        function addFun() {
            parent.$.modalDialog({
                ...
                width : 400,
                height : 200,
                href : '${path }/t_airport_warning_threshold/addPage',
                buttons : [ {
                    text : '确定',
                    handler : function() {
        ...
        function editFun(id) {
            ...
            parent.$.modalDialog({
                ...
                width : 500,
                height : 200,
                href : '${path }/t_airport_warning_threshold/editPage?id=' + id,
                buttons : [ {
                    text : '确定',
                    handler : function() {
        ...
        function deleteFun(id) {
            ...
            parent.$.messager.confirm('询问', '您是否要删除当前预警阀值信息？', function(b) {
                if (b) {
                    progressLoad();
                    $.post('${path }/t_airport_warning_threshold/delete', {
                        id : id
                    }, function(result) {
                        if (result.success) {
