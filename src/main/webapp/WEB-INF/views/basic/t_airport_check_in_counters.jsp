...
<head>
    ...
    <title>值机柜台信息管理</title>
    <script type="text/javascript">
        var dataGrid;
        $(function() {
            dataGrid = $('#dataGrid').datagrid({
                url : '${path }' + '/t_airport_check_in_counters/dataGrid',
                striped : true,
                rownumbers : true,
                pagination : true,
                singleSelect : true,
...
// 		}]);
        ...
        function addFun() {
            parent.$.modalDialog({
                ...
                width : 400,
                height : 250,
                href : '${path }/t_airport_check_in_counters/addPage',
                buttons : [ {
                    text : '确定',
                    handler : function() {
        ...
        function editFun(id) {
            ...
            parent.$.modalDialog({
                ...
                width : 400,
                height : 250,
                href : '${path }/t_airport_check_in_counters/editPage?id=' + id,
                buttons : [ {
                    text : '确定',
                    handler : function() {
        ...
        function deleteFun(id) {
            ...
            parent.$.messager.confirm('询问', '您是否要删除当前值机柜台信息？', function(b) {
                if (b) {
                    progressLoad();
                    $.post('${path }/t_airport_check_in_counters/delete', {
                        id : id
                    }, function(result) {
                        if (result.success) {
