...
public class Bag_operlog_h {
    ...
    public Bag_operlog_h() {
        super();
    }

    public Bag_operlog_h(Long id) {
        this.id = id;
    }

    public Bag_operlog_h(Long id, Date tm, String bgcode, String plandatetime, String aircorp, String fltno, String status, String opercontent, String operater, String airportid, String remartk, String by1, String by2, String by3, String by4, String by5, String by6, String by7, String by8, String by9, String by10) {
        this.id = id;
        this.tm = tm;
        this.bgcode = bgcode;
