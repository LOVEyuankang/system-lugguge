 ...
 * 旅客值机信息表 Entity
 */
public class T_airport_passenger {
	...
	public T_airport_passenger() {
		super();
	}

	public T_airport_passenger(Long id) {
		this.id = id;
	}

	public T_airport_passenger(Long id, String plandatetime, String aircorp, String fltno, String name, String code, String cw, Long chknum, Date chktm, String airportid, String remartk, String by1, String by2, String by3, String by4, String by5, String by6, String by7, String by8, String by9, String by10) {
		this.id = id;
